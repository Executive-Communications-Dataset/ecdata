...
load_ecd(language = 'French')

```

This will only load data for a specific language. In this case this is equivalent of setting `country = 'France'` however, for English, Spanish, German, and Portugese will load data from multiple countries. 
