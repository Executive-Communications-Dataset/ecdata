...
ec.load_ecd(country = 'Turkey').head(int = 2)
...
Additionally some common abbreviations/names of countries are supported. So this will work as expected

```{r}
#| eval: false


load_ecd('South Korea')
